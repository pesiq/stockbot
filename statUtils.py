...
def createFolder(name) -> 'Creates a symbol folder if was not yet created':
...
def responseParse(data) -> 'Compiles response into an object and calls for further action':
